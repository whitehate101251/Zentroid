...
private:
    ...
    // vertex buffer object (VBO): default is VertexBuffer (GL_ARRAY_BUFFER) type
    QOpenGLBuffer m_vbo;

    // shader program: compile and link shaders
    QOpenGLShaderProgram m_shaderProgram;

    // YUV textures, used to generate texture maps
