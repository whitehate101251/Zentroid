...
struct UserBootConfig
{
    ...
    bool cleanMode        = true;   // true = clean mode (default), false = legacy mode
    bool darkMode         = true;   // true = dark theme (default), false = light theme
    int  renderDriverIndex = -1;    // -1=auto, 0=software, 1=ANGLE/OpenGL ES, 2=Desktop OpenGL
};
