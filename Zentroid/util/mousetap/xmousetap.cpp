...
#elif __has_include(<QtGui/private/qtx11extras_p.h>)
#include <QtGui/private/qtx11extras_p.h>
#else
// GuiPrivate not available — provide stub so this file compiles.
// Mouse grab functionality will be non-functional.
#include <xcb/xproto.h>
class QX11Info {
public:
    static xcb_connection_t *connection() { return nullptr; }
    static int appScreen() { return 0; }
    static xcb_window_t appRootWindow(int /*screen*/ = 0) { return 0; }
};
#endif
