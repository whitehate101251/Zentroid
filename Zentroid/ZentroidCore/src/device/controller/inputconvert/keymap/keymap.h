...
public:
    ...
    int getSwitchKey();
    Qt::KeyboardModifiers getSwitchModifiers();
    bool hasSuspendKey();
    int getSuspendKey();
...
private:
    ...
    Qt::KeyboardModifiers m_switchModifiers = Qt::NoModifier;
    KeyNode m_suspendKey = { AT_INVALID, -1 }; // hold-to-disable key (e.g. Key_X)
