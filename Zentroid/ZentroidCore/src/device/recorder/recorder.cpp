...
bool Recorder::open()
{
    ...
    QString comment = "Recorded by Zentroid " + QCoreApplication::applicationVersion();
...
#ifdef ZENTROID_LAVF_HAS_NEW_CODEC_PARAMS_API
...
{
#ifdef ZENTROID_LAVF_HAS_NEW_MUXER_ITERATOR_API
